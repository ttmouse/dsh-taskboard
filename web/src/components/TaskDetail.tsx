        ...
        <div className="issue-detail-layout">
          ...
          <aside className="issue-properties" aria-label={text("议题属性", "Issue properties")}>
            ...
            <label className="detail-property-row workflow-property">
              ...
              <span className="detail-property-label">{text("工作流", "Workflow")}</span>
              <select
              ...
              >
                <option value="">{text("未绑定", "Not linked")}</option>
                {!workflowAvailable && currentTask.workflowId && (
                  <option value={currentTask.workflowId}>{text("当前设备未找到此流程", "Workflow not found on this device")}</option>
                )}
