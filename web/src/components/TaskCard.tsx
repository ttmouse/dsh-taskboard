...
interface FullTaskCardProps extends CommonTaskCardProps {
  variant: "main" | "sidebar";
...
function ProcessingProgress({ presentation }: { presentation: TaskCardPresentation }) {
...
/** 上游完整卡片：由 OtherTasksPanel 等上游组件调用 */
